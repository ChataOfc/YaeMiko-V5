...
if (db.data.chats[m.chat].nsfw == false && m.isGroup) return conn.sendButton(m.chat, 'ᴏᴘᴛɪᴏɴs ɴsғᴡ ᴅɪᴄʜᴀᴛ ɪɴɪ ʙᴇʟᴜᴍ ᴅɪɴʏᴀʟᴀᴋᴀɴ ᴏʟᴇʜ ᴀᴅᴍɪɴ ɢʀᴏᴜᴘ',wm.date, null, [['Aktifkan', '.on nsfw']], m)
